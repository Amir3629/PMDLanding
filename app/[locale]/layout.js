...
const CONFIG = {
  tr: {
    ...
    description: 'PayMyDine; restoran operasyonlarını, rol bazlı takım çalışma alanlarını, müşteri siparişini, mutfak akışını, ödemeleri, canlı içgörüleri, entegrasyonları ve Yapay Zeka desteğini tek bir uyarlanabilir platformda bir araya getirir.',
    Header: HeaderTr,
    Footer: FooterTr,
