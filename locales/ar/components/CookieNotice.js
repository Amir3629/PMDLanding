...
export default function CookieNotice() {
  ...
  return <aside className="cookieNotice" role="dialog" aria-label={"تفضيلات ملفات تعريف الارتباط"} aria-live="polite">
      ...
      <p>
        نستخدم مساحة التخزين الأساسية في المتصفح لحفظ تفضيلات الموقع. ويمكنك أيضًا السماح بملفات تعريف ارتباط اختيارية للتحليلات لمساعدتنا على فهم استخدام الموقع عند تفعيل التحليلات.
      </p>
