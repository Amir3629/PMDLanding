...
export default function CompanyPage() {
  return <>
      ...
      <CTA title={"تقييم نظام &quot; بي ميدين &quot; مقابل تدفق حقيقي للعمل في المطعم، وليس قائمة عامة."} body={"جلب الأدوار، والنظم الحالية، والعمل المتكرر، والمقاييس وراء مشكلة تشغيل واحدة. وسنرسم خرائط لمناطق المنتجات والحدود ذات الصلة."} />
    </>;
}
