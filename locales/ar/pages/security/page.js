...
export const metadata = {
  title: "بيانات الأمن",
  description: "استعراض عملي لإمكانية الوصول إلى الأدوار، وتدفقات البيانات، وحدود التكامل، وضوابط النشر في نظام &quot; بي ديين &quot; ."
};
const topics = [["الوصول إلى الأدوار", "وثيقة من بين 6 أماكن عمل يمكن أن تنظر إلى كل نوع من بيانات المطاعم والضيوف، أو تخلقها أو تغيرها أو توافق عليها أو تصدرها."], ["تدفق البيانات", "خريطة المصدر، والمقصد، والغرض، والاحتفاظ بالطرف المسؤول عن الجدول، والنظام، والضيف، والدفع، وبيانات الإبلاغ."], ["حدود التكامل", "تسجيل الأذون الصادرة عن مكتب المدعي العام، والمجالات المتاحة، وطريقة التوثيق، ومناولة الفشل لكل نظام خارجي للدفع أو التسليم."], ["ضوابط النشر", "استعراض الاستضافة، والدعم، وقطع الأشجار، والرصد، ومناولة الحوادث، ومسؤوليات مقدمي الخدمات عن البيئة الفعلية المنتشرة."]];
export default function SecurityPage() {
  return <>
      <PageHero eyebrow={"4 مجالات استعراض أمني"} title={"استعراض إمكانية الوصول، وتدفق البيانات، والإدماجات، والنشر ضد التشكيلة الحقيقية."} intro={"وينبغي للمطالبات الأمنية أن تصف البيئة المنتشرة بالفعل. ومن ثم تبدأ مناقشات PayMyDine بأدوار ونظم مترابطة ومسؤوليات بيانات وضوابط تشغيلية بدلا من الوعود العامة."} image="/site-assets/extra/office-dashboard.webp" accent="green" />
      ...
      <section className="section capabilitySection">
        <div className="container capabilityPanel">
          ...
          <div className="capabilityList"><span>تصاريح الدور</span><span>جرد البيانات</span><span>وثائق تفويض الإدماج</span><span>الاستبقاء والدعم</span><span>التعبئة والرصد</span><span>مسؤولية الحوادث</span></div>
        </div>
      </section>
