...
const factors = [["نطاق المطاعم والموقع", "عدد المواقع، والتعقيدات الأرضية، ونموذج الخدمة، وقنوات النظام والبيئات التي يجب أن تدعمها التشكيلة."], ["مجالات مختارة من المنتجات", "وأُدرجت الآن أي من مجالات المنتجات التسعة، التي يُخطط لها فيما بعد وما زالت النظم الحالية ذات حجية."], ["نطاق الدور والوصول", "أي من الحيزات الستة المطلوبة للعمل، وكم تختلف التصاريح وعدد الأفرقة أو المواقع التي تحتاج إلى كل وجهة نظر."], ["أعمال التكامل والتنفيذ", "النظام المؤيد للخدمة العامة، والمدفوعات، والمحاسبة، والتوصيل، بالإضافة إلى التشكيل، والهجرة، والتحقق، وإعداد الأفرقة."]];
export default function PricingPage() {
  return <>
      <PageHero eyebrow={"4 مدخلات للتسعير"} title={"قم بتسعير نطاق التشكيل والتنفيذ والتكامل الذي ستستخدمه فعلاً"} intro={"يبدأ اقتراح عملي بمواقع، ومجالات مختارة من المنتجات، وأماكن عمل، وأعمال التكامل. وينبغي لها أيضاً أن تذكر ما تبقى خارج نظام &quot; بي ميدين &quot; وما هي الافتراضات التي تؤثر على النطاق النهائي."} image="/site-assets/extra/qr-couple.webp" accent="green" />
