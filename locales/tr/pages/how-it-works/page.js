...
const flowSteps = [
  ...
  ['05', 'Operasyon yönetim verisine dönüşür', 'Gelir, müşteri sayısı, ortalama hesap tutarı, masa devir hızı, satış zamanlaması ve kârlılık raporlamayı ve Yapay Zeka destekli soruları besler.']
];

const operationsCards = [
  { eyebrow: '6 rol bazlı çalışma alanı', title: 'Her rol sorumlu olduğu iş listesini, kontrolleri ve durum bilgisini görür.', body: 'İşletme sahipleri, yöneticiler, servis personeli, mutfak, rezervasyon ve finans odaklı görünümler kullanırken temel restoran içeriği ortak kalır.', image: '/site-assets/owner/1.webp', alt: 'PayMyDine restoran operasyon görünümü' },
...
export default function HowItWorksPage() {
  return (
    <>
      ...
      <CTA title="Gerçek bir restoran yolculuğunu 5 adımın tamamında eşleyin." body="Bir rezervasyon, masa siparişi, mutfak iş devri veya ödeme akışı getirin. Her adımda işlemi, içeriği, rolü, durumu ve ölçütü birlikte tanımlayalım." primaryLabel="Tanıtım talep et" primaryHref="/tr/contact" secondaryLabel="9 Ürün Alanını Keşfedin" secondaryHref="/tr/platform" />
    </>
  );
}
