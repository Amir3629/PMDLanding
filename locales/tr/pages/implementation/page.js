...
const steps = [
  ['01', 'Mevcut operasyonu belgeleyin', 'Rolleri, salon yapısını, sipariş kanallarını, müşteri temas noktalarını, mevcut sistemleri, tekrar veri girişini ve yönetimin bugün kullandığı ölçütleri listeleyin.'],
  ...
  ['06', 'Canlıya geçin ve ölçün', 'Bekleme süresi, hazırlık süresi, masa devir hızı, ortalama hesap tutarı, ödeme süresi veya tekrar ziyaret oranı gibi kabul edilen başlangıç ölçütlerini takip edin ve yapılandırmayı buna göre geliştirin.']
];
