...
export const metadata = {
  ...
  description: 'PayMyDine’ın restoran operasyonlarını, ekip rollerini, müşteri deneyimini, ödemeleri, analizleri ve Yapay Zeka destekli kararları nasıl bir araya getirdiğini keşfedin.'
};
...
export default function CompanyPage() {
  return (
    <>
      ...
      <section className="section companyValues">
        <div className="container companyValuesGrid">
          <div>
            ...
            <h2>Her özellik; kimin işlem yaptığını, hangi bilginin gerekli olduğunu, tamamlanmayı hangi durumun gösterdiğini ve hangi ölçütün etkilendiğini açıklamalıdır.</h2>
          ...
          <div className="companyValueCards">
            <article><h3>Rol sorumluluğu</h3><p>İşletme sahipleri, yöneticiler, servis personeli, mutfak, rezervasyon ve finans takımlari kendi görevlerine uygun kontroller ve yetkiler kullanır.</p></article>
      ...
      <CTA title="PayMyDine’ı genel bir özellik listesiyle değil, gerçek bir restoran iş akışıyla değerlendirin." body="Bir operasyon probleminin arkasındaki rolleri, mevcut sistemleri, tekrarlanan işleri ve ölçütleri paylaşın. İlgili ürün alanlarını ve sınırları birlikte belirleyelim." />
    </>
  );
}
